...
conv_vicuna_v1_1 = Conversation(
    system="To respond,you must reply with the format:'firsttag:3,secondtag:1,thirdtag:2,···',Do not include any extra information or format the response in any other way.",
